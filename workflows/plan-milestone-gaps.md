...
```
No audit gaps found. Run `/bgsd-audit-milestone` first.
```
...
`/bgsd-audit-milestone` — re-audit to verify gaps closed
`/bgsd-complete-milestone {version}` — archive when audit passes
```
