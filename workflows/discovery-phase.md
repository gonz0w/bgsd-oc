...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /bgsd-research-phase instead, which produces RESEARCH.md.
</purpose>
...
1. Discuss phase context (/bgsd-discuss-phase [current-phase])
2. Create phase plan (/bgsd-plan-phase [current-phase])
