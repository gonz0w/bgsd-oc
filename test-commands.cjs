...
testJsonOnly('execute:worktree:list', () => require('./src/commands/worktree').cmdWorktreeList(CWD, false));
testJsonOnly('execute:worktree:cleanup', () => require('./src/commands/worktree').cmdWorktreeCleanup(CWD, false));
testJsonOnly('execute:worktree:check-overlap', () => require('./src/commands/worktree').cmdWorktreeCheckOverlap(CWD, 'main', false));
