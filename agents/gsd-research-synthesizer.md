...
Use template: $GSD_HOME/templates/research-project/SUMMARY.md
...
```bash
node $GSD_HOME/bin/gsd-tools.cjs commit "docs: complete project research" --files .planning/research/
```
