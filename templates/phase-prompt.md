...
> **Note:** Planning methodology is in `agents/bgsd-planner.md`.
...
@__OPENCODE_CONFIG__/get-shit-done/references/checkpoints.md
</execution_context>
...
<!-- For checkpoint task examples and patterns, see @__OPENCODE_CONFIG__/get-shit-done/references/checkpoints.md -->
...
**Wave is pre-computed:** Wave numbers are assigned during `/bgsd-plan-phase`. Execute-phase reads `wave` directly from frontmatter and groups plans by wave number. No runtime dependency analysis needed.
...
See `__OPENCODE_CONFIG__/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `__OPENCODE_CONFIG__/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `__OPENCODE_CONFIG__/get-shit-done/workflows/verify-phase.md` for verification logic.
