...
**New Template:**
- Implementation: `bgsd-oc/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `bgsd-oc/workflows/{name}.md`
- Usage: Reference from command with `@__OPENCODE_CONFIG__/bgsd-oc/workflows/{name}.md`

**New Reference Document:**
- Implementation: `bgsd-oc/references/{name}.md`
...
**bgsd-oc/**
- Purpose: Resources installed to __OPENCODE_CONFIG__/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to __OPENCODE_CONFIG__/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
