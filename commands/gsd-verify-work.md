...
<execution_context>
@__OPENCODE_CONFIG__/get-shit-done/workflows/verify-work.md
...
<process>
Execute the verify-work workflow from @__OPENCODE_CONFIG__/get-shit-done/workflows/verify-work.md end-to-end.
