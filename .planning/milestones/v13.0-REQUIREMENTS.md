# Requirements Archive: v13.0 Closed-Loop Agent Evolution
...
- [ ] **LESSON-02:** Structured lessons live in `.planning/memory/lessons.json` as the canonical source consumed by capture, list, search, analysis, and suggestion workflows
