...
Run `node bin/gsd-tools.cjs mcp-profile --raw` from a project with MCP servers — servers should have relevance scores and recommendations.
  </verify>
  <done>
...
- `node bin/gsd-tools.cjs mcp-profile --raw` from a project includes relevance and recommendations for all servers
