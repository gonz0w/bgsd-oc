...
Use the `{gsd-tools-path}` pattern consistent with other CLI invocations in the workflow (full path: `node __OPENCODE_CONFIG__/get-shit-done/bin/gsd-tools.cjs`).
