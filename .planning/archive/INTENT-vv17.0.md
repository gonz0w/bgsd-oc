...
<outcomes>
### Active milestone outcomes

**DO-118:** Replace Git worktree execution with a JJ-first workspace and operation-log recovery model using `.planning/research/jj-workspace-execution-prd.md`

**DO-119:** Reduce the visible command footprint around a smaller canonical command set with grouped families, stronger help, and command-reference validation using `.planning/research/command-footprint-reduction-prd.md`

**DO-120:** Add cascading project -> milestone -> phase intent with compact `effective_intent` injection using `.planning/research/intent-cascade-prd.md`
