...
node /home/cam/.config/opencode/get-shit-done/bin/gsd-tools.cjs commit "docs: update state" --files .planning/STATE.md
...
**Note:** Most bGSD operations use direct file reads or explicit paths, which work regardless of gitignore status.
