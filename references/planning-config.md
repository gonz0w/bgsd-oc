...
node __OPENCODE_CONFIG__/get-shit-done/bin/gsd-tools.cjs commit "docs: update state" --files .planning/STATE.md
...
INIT=$(node __OPENCODE_CONFIG__/get-shit-done/bin/gsd-tools.cjs init execute-phase "1")
